# IsAdditivePrime: Additive primes can be defined as prime numbers where the
#  sum of its digits is a prime number. Write a function isAdditivePrime
#  that takes n as an integer 
# and returns True if n is an Additive Prime and False otherwise.

# IsAdditivePrime: Additive primes can be defined as prime numbers where the
#  sum of its digits is a prime number. Write a function isAdditivePrime that 
# takes n as an integer and returns True if n is an Additive Prime and False otherwise.
